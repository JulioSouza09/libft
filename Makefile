...
#    Updated: 2025/09/08 18:36:09 by jcesar-s         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CFILES += ft_printf_fd/ft_printf_fd.c ft_printf_fd/ft_putchar.c 
CFILES += ft_printf_fd/ft_putnbr_hex.c ft_printf_fd/ft_putnbr_u.c
CFILES += ft_printf_fd/ft_putstr.c ft_printf_fd/ft_putnbr.c
CFILES += ft_printf_fd/ft_putptr.c
